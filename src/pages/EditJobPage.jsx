    ...
    return (
        <>
            ...
            <div className="flex items-center justify-center bg-gray-100">
                <Modal isOpen={isModalOpen} onClose={closeUpdateModal} onConfirm={handleConfirmUpdate}>
                    <h3 className="text-lg font-bold mt-0 pt-0 text-center">Do you want to Update this job?</h3>
